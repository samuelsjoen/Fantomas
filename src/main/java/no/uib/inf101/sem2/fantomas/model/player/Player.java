...
public class Player implements Iterable<GridCell<Character>> {
    ...
    public Player(char symbol, boolean[][] orientation, CellPosition pos) {
        super();
        this.symbol = symbol;
    ...
    public static boolean[][] newOrientation(char symbol) {
    ...
    // Shifts the player to the centre of the board
